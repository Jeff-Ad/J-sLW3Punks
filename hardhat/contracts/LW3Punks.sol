...
import "@openzeppelin/contracts/utils/Strings.sol";
 ...
 contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    /**
     *baseTokenURI for computing {tokenURI}, If set, the resulting URI for each 
...
uint256 public tokenIds;
     ...
     * Construction for LW3P takes in the baseURI to set _baseTokenURI for the collection 
     */
